...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="hero-inner">
          ...
          <div className="fade-in">
            <span className="avail-badge">
              ...
              Open to Opportunities — Graduating 2025
            </span>
          </div>
      ...
      <div className="looking">
        <div className="looking-inner">
          ...
          <span>
            ...
            — available from mid-2025. Open to on-site, hybrid, or remote.
          </span>
        </div>
      </div>
          ...
          <div className="edu-card">
            ...
            <div>
              ...
              <div className="edu-badges">
                <span className="eb-green">Final Year · Graduating 2025</span>
      ...
      <footer>© 2025 Manan Pal · KIIT University, Bhubaneswar · Built for production-level engineering roles</footer>
